...
class FaceFragment : Fragment() {
    ...
    private lateinit var vlStatusDetect: TextView
...
//                    cameraViewVideo.stopVideo()
            ...
            override fun onProcessing(isSmile: Boolean) {
                super.onProcessing(isSmile)
                if (isSmile) {
                    vlStatusDetect.text = "Winking..."
                } else {
                    vlStatusDetect.text = "Smiling..."
                }
            }
